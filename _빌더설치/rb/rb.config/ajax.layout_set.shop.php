        ...
        <div
            ...
            >
                ...
                <?php if(isset($row_mod['md_type']) && $row_mod['md_type'] == "item") { ?>
                    ...
                    ?>
                    <div class="rb-module-wrap module_item_wrap md_arrow_<?php echo isset($row_mod['md_arrow_type']) ? $row_mod['md_arrow_type'] : ''; ?>" style="<?php if(empty($row_mod['md_height']) || isset($row_mod['md_height']) && $row_mod['md_height'] == "auto") { ?>height:auto<?php } else { ?>height:<?php echo $row_mod['md_height'] ?>px<?php } ?>;">
                    <?php

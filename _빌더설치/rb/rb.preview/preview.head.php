...
?>
    ...
    if (isset($preview_core['layout_hd']) && $preview_core['layout_hd'] == "") {
    ...
    } else if (isset($preview_core['layout_hd'])) { 
        // 레이아웃 인클루드
        include_once(G5_THEME_PATH . '/rb.layout_hd/' . $preview_core['layout_hd'] . '/header.php'); 
    } else {

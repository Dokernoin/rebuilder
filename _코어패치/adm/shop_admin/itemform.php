    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                ...
                <?php echo get_member_level_select('it_level', 1, $member['mb_level'], $it['it_level']) ?>

                <select id="it_level_opt" name="it_level_opt">
                <option value="1" <?php if (isset($it['it_level_opt']) && $it['it_level_opt'] == "1") { ?>selected<?php } ?>>레벨 부터 접근가능</option>
                <option value="2" <?php if (isset($it['it_level_opt']) && $it['it_level_opt'] == "2") { ?>selected<?php } ?>>레벨만 접근가능</option>
                </select>
            </td>
            <td class="td_grpset">
                <input type="checkbox" name="chk_ca_it_level" value="1" id="chk_ca_it_level">
                <label for="chk_ca_it_level">분류적용</label>
                <input type="checkbox" name="chk_all_it_level" value="1" id="chk_all_it_level">
...
<section id="anc_sitfrm_cost">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td colspan="2">
                <?php echo help("상품이 품절인 경우에 체크해 놓으면 상품상세보기에서 고객이 재입고 알림을 신청할 수 있게 됩니다."); ?>
